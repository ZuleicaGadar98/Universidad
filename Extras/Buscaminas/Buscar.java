...
public class Buscar {
    ...
    public static void main(String[] args) {
        ...
        n = Integer.parseInt(JOptionPane.showInputDialog("Escribe las dimencion del tablero nxn"));
        while (n <= 0) {
            
            n = Integer.parseInt(JOptionPane.showInputDialog("los negativos no cuentan, introdusca la dimencion otra vez "));
        }
    ...
    private static int[] checkIndexes(int i, int j, int n) {
        ...
        while (!(i >= 0 && i < n && j >= 0 && j < n)) {
            ...
            i = Integer.parseInt(JOptionPane.showInputDialog("Introduzca el indice de la fila"));
         
            j = Integer.parseInt(JOptionPane.showInputDialog("introduzca el indice de la columna"));
        }
        vector[0] = i;
        vector[1] = j;
        return vector;
